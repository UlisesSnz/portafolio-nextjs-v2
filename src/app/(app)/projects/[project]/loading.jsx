                ...
                <div className="max-w-full mx-auto lg:px-0 px-8">
                    <div className="flex flex-col items-center w-full mb-6">
                        ...
                        <div className="flex w-full items-center justify-center my-6 sm:mb-2">
                            <span className="w-2/12 sm:w-3/12 h-5 bg-[#1d1d20] rounded-lg animate-pulse"></span>
                            <span className="w-2/12 sm:w-3/12 h-5 bg-[#1d1d20] rounded-lg animate-pulse mx-6"></span>
                            <span className="w-2/12 sm:w-3/12 h-5 bg-[#1d1d20] rounded-lg animate-pulse"></span>
                        </div>
