            ...
            <Layout className="!pt-0 md:!pt-14 sm:!pt-14">
                <div className="flex items-center justify-between w-full lg:flex-col">
                    ...
                    {profile && profile.map(data => (
                        <div key={data._id} className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
                            <AnimatedText text={data.headline} className="!text-6xl !text-left
