...
const FeaturedProyect = ({type, title, summary, img, link, github}) =>{
  return(
...
const projects = () => {
  return (
    <>
      <Head>
        <title>Proyectos | Ulises Sánchez</title>
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          <AnimatedText
            text="La innovación reside en el conocimiento e imaginación"
